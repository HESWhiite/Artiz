...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS completion_rate NUMERIC(5,2) DEFAULT 0;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS response_rate NUMERIC(5,2) DEFAULT 0;
